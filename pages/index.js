  ...
  return (
    <div className={`w-screen h-screen theme-t${theme}`}>
      <div className='flex items-center relative justify-center w-full h-full bg-[#3A4764] t2:bg-[#E6E6E6] t3:bg-[#160628]'>
        ...
        <a href='https://github.com/FuadHy/nextjs-tailwindcss-calc' target={'_blank'} className='w-full text-center text-[#dfdfdf] t2:text-[#000000] no-underline absolute bottom-3 text-[9px]'>github.com/fuadhy</a>
      </div>
